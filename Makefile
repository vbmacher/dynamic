...
BIN  = ../dynamic
CXXFLAGS = $(CXXINCS) -O3 -m32 -msse2 -Wfloat-equal -Wpointer-arith -DATI_OS_LINUX -g3 -ffor-scope -enable-auto-import  
CFLAGS = $(INCS) -O3 -m32 -msse2 -Wfloat-equal -Wpointer-arith -DATI_OS_LINUX -g3 -enable-auto-import  
RM = rm -f
